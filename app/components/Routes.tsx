...
const routes = [
    ...
    { type: "chinchi", number: "A-18", fare: 20,                 details: "Short Distance Ride", stops: ["CHUNGI GHAZI", "SAIMA ARABIAN VILLAS", "NORTH TOWN RESIDENCY (PHASE 1)","ALHAMEED","W9 STOP","KHAWAJA AJMER NAGRI","BARADARI","DISCO MOR","UP MOR","NAGAN CHOWRANGI","SHAFIQ MOR","ALNOOR","SOHRAB GOTH","LUCKY ONE MALL","GULSHAN CHOWRANGI","NIPA","ALADIN PARK","JOHAR MOR","MILLINNIUM MALL"] },
    ...
    { type: "chinchi", number: "K-18",   fare: 20,               details: "Short Distance Ride", stops: ["CHUNGI GHAZI","SAIMA ARABIAN VILLAS","BABA MOR","AL HAMEED","W-9 STOP","KHAWAJA AJMER NAGRI","BARADARI","DISCO MOR","UP MOR","NAGAN CHOWRANGI","SHAFIQ MOR","AL NOOR","SOHRAB GOTH","LUCKY ONE MALL","GULSHAN CHOWRANGI","NIPA","ALADIN PARK","JOHAR MOR","MILLENNIUM MALL"] },
    ...
    { type: "chinchi", number: "V-1",    fare: 20,               details: "Short Distance Ride", stops: ["BABA MOR","AL HAMEED","RAHMANIA MOR","W-9 STOP","KHAWAJA AJMER NAGRI","BARADARI BUS STOP","DISCO MOR","UP MOR","NAGAN CHOWRANGI","SAKHI HASAN CHOWRANGI","SAREENA MOBILE MARKET","JUMMAH BAZAAR","FIVE STAR CHOWRANGI","HYDERI","KDA CHOWRANGI","BOARD OFFICE","NAZIMABAD PETROL PUMP","ANNU BHAI PARK","ENQUIRY OFFICE","NAZIMABAD NO.1","SANITARY MARKET (GULBAHAR)","LASBELA","GARDEN"] },
